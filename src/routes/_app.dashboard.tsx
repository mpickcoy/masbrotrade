...
function Dashboard() {
  ...
  const css = `
    ...
    *, *::before, *::after { box-sizing:border-box; }
    ...
    .lg-topbar-right { display:flex; align-items:center; gap:10px; }
    ...
    .lg-card-value {
      font-family:'Syne',sans-serif; font-weight:800;
      font-size:1.72rem; letter-spacing:-1px; line-height:1;
    ...
    @media (max-width:1024px) {
      .lg-wrap            { padding:20px 18px; }
      .lg-cards           { grid-template-columns:repeat(2,1fr); gap:12px; }
    ...
    @media (max-width:640px) {
      .lg-wrap    { padding:12px 12px 110px; }
      .lg-topbar  { margin-bottom:12px; }
      .lg-title   { font-size:1rem; }
      .lg-date-pill { display:none; }

      .lg-cards { grid-template-columns:1fr 1fr; gap:8px; margin-bottom:10px; }
      .lg-card  { padding:14px 12px; border-radius:16px; }
      .lg-card-label { font-size:.54rem; gap:4px; margin-bottom:6px; }
      .lg-card-value { font-size:1.15rem; margin-bottom:5px; }
